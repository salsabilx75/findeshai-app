...
/* ============================================================
   ...
   Same real BD data + logic as v2 — fully redesigned UI
   ============================================================ */

const INFLATION = 8.5;

/* ---------------- INVEST INSTRUMENTS (unchanged data) ---------------- */
const INSTRUMENTS = [
...
/* ---------------- SAVINGS PRODUCTS (unchanged data) ---------------- */
const SAVINGS = [
